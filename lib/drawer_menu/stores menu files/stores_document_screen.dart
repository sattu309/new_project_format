...
import 'package:volpes/drawer_menu/stores%20menu%20files/store_doc_subcategory.dart';
...
class StoreDocumentsScreen extends StatefulWidget {
  ...
  const StoreDocumentsScreen({super.key, required this.categoryName, required this.categoryId});

  @override
  State<StoreDocumentsScreen> createState() => _StoreDocumentsScreenState();
}
            ...
            GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Get.to(()=>StoreSubCategoryDocumentsScreen(categoryName: docData.category.toString(), categoryId: docData.id.toString(),));
